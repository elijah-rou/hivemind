    ...
    return &servingv1.Service{
        ObjectMeta: metav1.ObjectMeta{
            ...
            Labels: map[string]string{
                "hivemind.dev/workload-id": workload.ID,
                "hivemind.dev/project-id":  workload.ProjectID,
            },
        },
...
kubectl -n hivemind annotate cluster ${CLUSTER_ID} hivemind.dev/enabled=false
