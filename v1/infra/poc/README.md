...
- Amazon Linux 2023 replica AMI ID and Hivemind worker AMI ID for the target region
...
# worker_ami_id:  Hivemind hivemind-standalone AMI (containerd + nydus + nvidia)
