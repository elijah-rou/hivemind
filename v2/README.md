...
The [wire fixture contract](tests/wire/README.md) documents a **current limitation and planned contract**: no shared normative corpus or gate exists. The [live safety contract](tests/live/README.md) documents a **current limitation and planned contract**: no unified guarded live gate exists. Neither path is a runnable acceptance gate today.
