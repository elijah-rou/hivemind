...
impl SimulatedNetwork {
    ...
    pub fn send_from_agent(&mut self, agent_id: usize, msg: WorkerMessage, current_tick: u64) {
        ...
        // handed to a socket. New sends after the boundary fail and are lost.
...
mod tests {
    ...
    #[test]
    fn partition_holds_inbound_and_loses_new_outbound_send() {
        ...
        assert_eq!(net.stats.worker_sent, 0);
        assert_eq!(net.stats.worker_bytes, 0);
