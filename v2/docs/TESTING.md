...
| Runtime stop/probe/run failure | Rust unit/simulation coverage is incomplete by fault | Only the named state/resource/status invariant is proven | Real process/containerd/network namespace behavior |
