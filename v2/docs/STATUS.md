...
- Historical evidence above and in the changelog remains historical. It attests only `bc9f5f63` / tree `78f4c95c`. The thematic ten-PR rewrite includes approved behavior and review corrections, so fresh full acceptance of its rewritten top is pending the final matrix; no historical pass is promoted to the current tip.
