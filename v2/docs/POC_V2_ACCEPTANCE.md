...
| `V2-02-field-startup` | Startup-timeout field. | `P-ABSENT` | no | deterministic only | blocked | Blocker: required product surface or acceptance harness is absent. |
| `V2-02-field-grace` | Termination-grace-period field. | `P-ABSENT` | no | deterministic only | blocked | Blocker: required product surface or acceptance harness is absent. |
| `V2-02-field-isolation` | Isolation-profile-reference field. | `P-ABSENT` | no | deterministic only | blocked | Blocker: required product surface or acceptance harness is absent. |
| `V2-02-api-accept` | Public API accepts `AppSpec v1`. | `P-ABSENT` | no | deterministic only | blocked | Blocker: required product surface or acceptance harness is absent. |
| `V2-02-core-persist` | Core state machine persists all required fields deterministically. | `P-ABSENT` | no | deterministic only | blocked | Blocker: required product surface or acceptance harness is absent. |
| `V2-02-worker-apply` | Worker receives and applies all required fields. | `P-ABSENT` | no | deterministic only | blocked | Blocker: required product surface or acceptance harness is absent. |
...
- The shared protocol-v6 corpus is current deterministic compatibility evidence. The guarded live harness is prepared, but its matrix remains unexecuted and blocked before ownership. GPU rows remain blocked on physical device reservation before live evidence can run.
